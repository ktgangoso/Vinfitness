    ...
    return (
        <div id="coaching">
            <Box sx={{
                ...
                display: "flex", justifyContent: "center", flexDirection: "column", paddingTop: { xs: "3rem", md: "0" },
            }}>
                <Box sx={{ padding: "1rem" }}>
                    ...
                    <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: { xs: "column", md: "row" }, gap: "2rem" }}>
                        <Card sx={{
                            ...
                            <CardMedia
                                sx={{ height: { xs: "12rem", md: "22rem"}, border: "2px solid black" }}
                            ...
                            <CardContent>
                                ...
                                <Typography variant="body2" sx={{ color: 'text.secondary', fontSize: {xs: ".7rem", md: ".8rem"} }}>
